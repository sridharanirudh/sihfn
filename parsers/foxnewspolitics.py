...
files = glob.glob('data/articles/foxnewspolitics/*')
orientation = "right"


tweetFile = gzip.open('data/tweets/foxnewspolitics.json.gz')
...
for fname in files[-25:]:
    ...
    mainText = ""
    div = soup.find(class_='article-body')
    if div:
        p = div.find_all('p')
        pindex = 0
        for p_ in p:
        ...
        if mainText:
            ...
            tree.write(f"/home/anirudh/ub/cse702/sihfn/data/parsed/foxnewspolitics/{findex}.xml")

            x = etree.parse(f"/home/anirudh/ub/cse702/sihfn/data/parsed/foxnewspolitics/{findex}.xml")
            f = open(f"/home/anirudh/ub/cse702/sihfn/data/parsed/foxnewspolitics/{findex}.xml", "wb+")
